    ...
    <?php if (isset($_COOKIE['woocommerce_recently_viewed'])): ?>
        <section class="hidden-xs">
            <div class="wrvpproduct-wrapper ">
                <span class="title">کالاهایی که دیده‌اید</span>
...
<!--                /********************************* BEGIN EDITED IN TIVA V5.8  ****************************/-->
                <?php if (!empty($tiva_options['index-page']['qrcode_show']) && $tiva_options['index-page']['qrcode_show'] === 'true'): ?>
                    <div class="col-lg-6 col-sm-6  hidden-xs col-xs-12">
                        <img class="qrcode" title="کپی رایت" src="<?php echo (isset($tiva_options['index-page']['qrcode'])) ? $tiva_options['index-page']['qrcode'] : ''; ?>" alt="کپی رایت">
                    </div>
                <?php endif; ?>
<!--                /********************************* END EDITED IN TIVA V5.8 ******************************/-->
            </div>
